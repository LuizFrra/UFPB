...
int main(int argc, char const *argv[])
{
    ////////////////////// EXEMPLO 2//////////////////////////////////////
    std::fstream fs;
    fs.open("redeslog.txt", std::ios::out | std::ios::trunc);
    fs.close();
    Coordenador *coordenador = new Coordenador(20, 20);
    coordenador->AdicionarHospedeiro(std::make_pair(2, 1), 3);
    coordenador->AdicionarHospedeiro(std::make_pair(1, 3), 3);
    coordenador->AdicionarHospedeiro(std::make_pair(3, 4), 3);
    coordenador->AdicionarHospedeiro(std::make_pair(5, 5), 3);
    coordenador->AdicionarHospedeiro(std::make_pair(6, 4), 3);
    coordenador->EnviarMensagem(1, 4, "de 1 para 3");
    coordenador->EnviarPacote();
    coordenador->EnviarMensagem(3, 1, "de 3 para 1");
    coordenador->EnviarPacote();
    coordenador->EnviarPacote();
    coordenador->EnviarPacote();
    coordenador->EnviarMensagem(2, 4, "de 2 para 4");
    ...
    // Coordenador *coordenador = new Coordenador(20, 20);
    // coordenador->AdicionarHospedeiro(std::make_pair(1, 1), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(1, 3), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(2, 3), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(2, 5), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(4, 5), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(4, 6), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(4, 8), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(4, 10), 2);
    // coordenador->AdicionarHospedeiro(std::make_pair(6, 10), 2);

    // coordenador->ImprimirHospedeiros(false);
    // coordenador->ImprimirMatrizDeAdjacencia();
    // coordenador->EnviarMensagem(1, 2, "de 1 para 2");
    // coordenador->EnviarMensagem(1, 8, "de 1 para 8");
    // coordenador->EnviarMensagem(7, 3, "de 7 para 3");
    // while(coordenador->EnviarPacote());
    /////////////////////// FIM EXEMPLO 1 ///////////////////////////////////////
    ...
    //     coordenador->AdicionarHospedeiro(std::make_pair(4, 3), 3);
    //     coordenador->AdicionarHospedeiro(std::make_pair(4, 3), 3);
    //     coordenador->AdicionarHospedeiro(std::make_pair(4, 3), 3);
    //     coordenador->AdicionarHospedeiro(std::make_pair(4, 3), 3);
    //     coordenador->AdicionarHospedeiro(std::make_pair(4, 3), 3);
